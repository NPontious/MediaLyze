...
test("installer URLs are immutable and tied to repository, tag, and filename", () => {
  const validUrl = "https://github.com/NPontious/MediaLyze/releases/download/v0.18.0/MediaLyze.AppImage";
  ...
  assert.equal(
    isAllowedInstallerDownloadUrl(
      "https://example.test/NPontious/MediaLyze/releases/download/v0.18.0/MediaLyze.AppImage",
      "0.18.0",
      "MediaLyze.AppImage",
    ),
    false,
    ...
    desktop_assets: [
      {
        ...
        download_url: "https://github.com/NPontious/MediaLyze/releases/download/v0.18.0/MediaLyze-arm64.dmg",
        size_bytes: 123,
        sha256: "a".repeat(64),
      },
    ],
